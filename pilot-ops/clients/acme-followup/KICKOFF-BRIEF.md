...
- Main contact: Hosted Test Lead 2
- Role: TBD
- Pilot dates: TBD
- Primary communication channel during pilot: email

## Core problem
The client reported this core issue: Replies lag when the team gets busy.
...
- client-specific win: Important leads get faster first responses.
...
- feedback owner: Hosted Test Lead 2
