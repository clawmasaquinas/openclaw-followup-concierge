# Kickoff Brief — Acme Followup

## Client snapshot
- Client / business: Acme Followup
- Main contact: Hosted Test Lead
- Role: TBD
- Pilot dates: TBD
- Primary communication channel during pilot: email
- Preferred intake mode: forwarded lead emails or shared lead inbox

## Core problem
The client reported this core issue: Inbound leads are answered too slowly.
...
- client-specific win: Faster replies to qualified leads within 14 days.
...
- feedback owner: Hosted Test Lead
